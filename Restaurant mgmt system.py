...
entryorder = Entry(f1,font=('Arial Bold',15), textvariable=rand , bd=8,insertwidth=2,bg='#b0e0e6').grid(row=0,column=2)

fries = Label(f1, font=('Arial Bold',17),text="Fries Meal",fg='#4682b4').grid(row=1,column=1)
entryfries = Entry(f1,font=('Arial Bold',15), textvariable=Fries , bd=8,insertwidth=2,bg='#b0e0e6').grid(row=1,column=2)

lunch = Label(f1, font=('Arial Bold',17),text="Lunch Meal",fg='#4682b4').grid(row=2,column=1)
entrylunch = Entry(f1,font=('Arial Bold',15), textvariable=Largefries , bd=8,insertwidth=2,bg='#b0e0e6').grid(row=2,column=2)


burger = Label(f1, font=('Arial Bold',17),text="Burger Meal",fg='#4682b4').grid(row=3,column=1)
entryburger = Entry(f1,font=('Arial Bold',15), textvariable=Burger , bd=8,insertwidth=2,bg='#b0e0e6').grid(row=3,column=2)

pizza = Label(f1, font=('Arial Bold',17),text="Pizza Meal",fg='#4682b4').grid(row=4,column=1)
entrypizza = Entry(f1,font=('Arial Bold',15), textvariable=Filet , bd=8,insertwidth=2,bg='#b0e0e6').grid(row=4,column=2)

Cheeseburger = Label(f1, font=('Arial Bold',17),text="Cheese burger",fg='#4682b4').grid(row=5,column=1)
entryCheese_burger = Entry(f1,font=('Arial Bold',15), textvariable=Cheese_burger , bd=8,insertwidth=2,bg='#b0e0e6').grid(row=5,column=2)

#-----------------------------------------------------------------------------------------
drinks = Label(f1, font=('Arial Bold',17),text="Drinks",fg='#4682b4').grid(row=0,column=3)
entrydrinks = Entry(f1,font=('Arial Bold',15), textvariable=Drinks , bd=8,insertwidth=2,bg='#b0e0e6').grid(row=0,column=4)

Cost = Label(f1, font=('Arial Bold',17),text="Cost",fg='#4682b4').grid(row=1,column=3)
entrycost = Entry(f1,font=('Arial Bold',15), textvariable=cost , bd=8,insertwidth=2,bg='#b0e0e6').grid(row=1,column=4)

Service_charge = Label(f1, font=('Arial Bold',17),text="Service Charge",fg='#4682b4').grid(row=2,column=3)
entryService_Charge = Entry(f1,font=('Arial Bold',15), textvariable=Service_Charge , bd=8,insertwidth=2,bg='#b0e0e6').grid(row=2,column=4)

tax = Label(f1, font=('Arial Bold',17),text="Tax",fg='#4682b4').grid(row=3,column=3)
entrytax = Entry(f1,font=('Arial Bold',15), textvariable=Tax , bd=8,insertwidth=2,bg='#b0e0e6').grid(row=3,column=4)

subtotal = Label(f1, font=('Arial Bold',17),text="Subtotal",fg='#4682b4').grid(row=4,column=3)
entrysubtotal = Entry(f1,font=('Arial Bold',15), textvariable=Subtotal , bd=8,insertwidth=2,bg='#b0e0e6').grid(row=4,column=4)

Totalamt = Label(f1, font=('Arial Bold',17),text="Total",fg='#4682b4').grid(row=5,column=3)
entryTotal = Entry(f1,font=('Arial Bold',15), textvariable=Total , bd=8,insertwidth=2,bg='#b0e0e6').grid(row=5,column=4)
